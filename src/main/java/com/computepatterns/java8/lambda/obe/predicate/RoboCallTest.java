...
/**
 * Improved code using lambda. Custom functional interface is replaced by the one from java.util.function
 */
public class RoboCallTest {
    public static void main(String[] args) {
        ...
        Predicate<Person> allWomenTean = person -> person.getGender() == Gender.FEMALE && person.getAge() < 20 &&
                person.getAge() > 15;
